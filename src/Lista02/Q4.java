...
class Cinema {
    ...
    private void setHorario(int horario) {
        ...
        } else throw new IllegalArgumentException("Insira um horário válido!");
    }
    ...
    public String toString() {
        return this.diaSemana + " " + this.horario + "h" + " - Inteira: R$ " + this.calculaValorInteira()
        + "\n" + this.diaSemana + " " + this.horario + "h" + " - Meia: R$ " + this.calculaValorMeia(); 
    }
}
