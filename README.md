...
* **Encapsulamento:** Uso de modificadores de acesso e métodos acessores.
* **Herança e Polimorfismo:** Reutilização de código e interfaces.
* **Abstração:** Modelagem de sistemas complexos.
...
### ☕ Java
Para compilar e rodar os arquivos Java:
```
...
> Este repositório serve como registro de evolução acadêmica na disciplina de POO (2026).
